...
function toggle_info_scheda(el){
    ...
    function esporta_xls2(el,tableid)
    {
        ...
        $('#hidden_form').attr('action', 'index.php/sys_viewcontroller/esporta_xls2');
        $('#hidden_form').submit();
        /*var serialized=$('#form_riepilogo').serializeArray();
...
function ajax_calendarioaziendale(el,recordid_azienda,anno)
{
    $('.bPopup_generico').html('attendere, generazione in corso');
    bPopup_generico = $('.bPopup_generico').bPopup();
    $.ajax( {
        dataType: 'html',
        url: controller_url + '/ajax_calendarioaziendale/'+recordid_azienda+'/'+anno,
        success: function( response ) {
            $('.bPopup_generico').html(response);
...
function ajax_salva_calendarioaziendale(el,recordid_azienda,anno)
{
...
function ajax_stampa_pdf_contratto_fornitura(el,recordid_contratto)
{ 
    bPopup_generico.close();
    $('.bPopup_generico').html('attendere, generazione in corso');
    bPopup_generico = $('.bPopup_generico').bPopup();
    $.ajax( {
        dataType: 'html',
        url: controller_url + '/ajax_stampa_pdf_contratto_fornitura/'+recordid_contratto,
        success: function( response ) {
            $('.bPopup_generico').html(response);
            bPopup_generico = $('.bPopup_generico').bPopup();
...
{ 
    ...
    $.ajax( {
        dataType: 'html',
        url: controller_url + '/ajax_report_ccl/'+recordid,
        success: function( response ) {
            $('.bPopup_generico').html(response);
        },
        error:function(){
