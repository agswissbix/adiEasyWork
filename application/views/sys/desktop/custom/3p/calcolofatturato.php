...
<div id="tabs" style="padding-left: 20px;overflow: scroll;height: 85%;width: 50%;margin: auto;background-color: white;padding: 10px;">
  ...
  <div id="nuovi">
      <?php
        ...
        ?>
      <div title="<?="v.".$ccl['versione']."  ".$ccl['datainizio']."  ".$ccl['datafine']?>" class="btn_ccl" onclick="ajax_load_content(this,'ajax_load_content_calcolofatturato_ccl/<?=$ccl['recordid_']?>')" style="padding: 5px;"><?=$ccl['nomeccl']?></div>
        <?php
        }
        ?>
  </div>
