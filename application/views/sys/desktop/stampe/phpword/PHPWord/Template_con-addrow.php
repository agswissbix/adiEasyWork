...
class PHPWord_Template {
    ...
    public function setValue($search, $replace) {
        ...
        $this->_documentXML = str_replace($search_key, $replace, $this->_documentXML);
        $this->_documentXML = str_replace($search_key2, $replace, $this->_documentXML);
    }
