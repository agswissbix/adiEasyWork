...
<div id="contratto_fornitura_content" class="print_page" style="">
    ...
    <div class="row">
        ...
        <div class="col s6" >
            <span style="text-decoration: underline">CCL:</span>  <?=$contratto_fornitura['cclcontratto']?>
        </div>
    </div>
    <div class="row">
        <div class="col s6">
    ...
    <div class="row">
        ...
        <div class="col s3">
            <?=$contratto_fornitura['tariffaoraria']?>
        </div>
        <div class="col s3">
    ...
    <div class="row">
        <div class="col s12">
            Il contratto quadro che avete ricevuto in data <?=$contratto_fornitura['datamandato']?> , entra in vigore solo al momento della firma del presente contratto di fornitura di personale a prestito, di cui fa parte integrante.
        </div>
    </div>
    <div class="row h3">
    </div>
